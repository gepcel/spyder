            ...
            ('shortcuts',
             {
              ...
              'editor/run cell': CTRL + '+Alt+Return',
              'editor/run cell and advance': 'Shift+Alt+Return',
              'editor/debug cell': '',
